      ...
      <header className="fixed w-full top-0 left-0 z-50 text-primary px-2 sm:px-10 border-b pt-[5px] pb-[5px] bg-body/80  backdrop-blur-sm border-[#D9D9D9]">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <a
              href="tel:+32494430347"
              className="flex items-center space-x-2 bg-primary text-body rounded-full py-2 px-4 hover:bg-opacity-80"
            >
              <svg
                width="20"
                height="23"
              ...
              >
                <path
                  d="M19.18 16.2202L15.0584 14.1005C14.8823 14.0105 14.6867 13.9915 14.5008 14.0464C14.315 14.1014 14.1491 14.2273 14.028 14.4052L12.2028 17.0813C9.33818 15.4605 7.03286 12.6941 5.68224 9.25664L7.9123 7.06633C8.06085 6.92135 8.16599 6.72223 8.21181 6.49913C8.25762 6.27602 8.24162 6.04108 8.16621 5.82987L6.39983 0.884006C6.31708 0.656324 6.17071 0.470428 5.98597 0.358375C5.80123 0.246322 5.5897 0.215134 5.38785 0.270189L1.56069 1.33002C1.36609 1.38394 1.19246 1.51543 1.06814 1.70302C0.943831 1.89062 0.876176 2.12323 0.876221 2.36291C0.876221 13.6898 8.52685 22.8529 17.9512 22.8529C18.151 22.8531 18.3449 22.7719 18.5013 22.6227C18.6577 22.4736 18.7674 22.2651 18.8123 22.0315L19.6955 17.439C19.7411 17.1956 19.7146 16.9407 19.6205 16.7183C19.5264 16.4958 19.3706 16.3197 19.18 16.2202Z"
                  fill="white"
                />
              </svg>
              <span>+32494430347</span>
            </a>
          </div>
        </div>
      </header>
